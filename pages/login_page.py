...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        assert self.is_substring_in_url_present('login'), "Substring 'login' is not presenter in current URL"
    ...
    def register_new_user(self, email, password):
        ...
        password_repeat_input = self.browser.find_element(*LoginPageLocators.REGISTER_PASSWORD_REPEAT_INPUT)
